...
// import 'package:tezal/utils.dart';
...
//                 child: Text('Flutter plugin: 2.5.0',
...
//             onNegative: (text) {
//               Pushe.sendNotificationToUser(
//                   IdType.AdvertisingId, text, 'Test title', 'Test content');
...
//         }
//         _updateStatus(
//             "Forced awareness to ${await Pushe.isForceForegroundAware()}");
//       },
