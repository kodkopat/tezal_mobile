...
const String storageKeyUserType = "USER_TYPE_STORAGE_KEY";
const String storageKeyUserLocation = "USER_LOCATION_STORAGE_KEY";
const String storageKeyLocalCode = "LOCAL_CODE_STORAGE_KEY";
