...
OrderSummaryListModel orderSummaryListModelFromJson(String str) =>
    OrderSummaryListModel.fromJson(json.decode(str));

String orderSummaryListModelToJson(OrderSummaryListModel data) =>
    json.encode(data.toJson());

class OrderSummaryListModel {
  ...
  factory OrderSummaryListModel.fromJson(Map<String, dynamic> json) =>
      OrderSummaryListModel(
