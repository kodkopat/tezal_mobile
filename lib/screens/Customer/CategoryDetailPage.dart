...
class _CategoryDetailPageState extends State<CategoryDetailPage> {
  ...
  Future<CategoryDetailModel> getCustomerCategoryDetail() async {
    ...
    var adres = DataService.customerBaseaddress + 'category/GetCategoryDetail/';
    var res = await http.get(
        Uri.http(DataService.authority, adres,
            {'MarketId': marketId, 'MainCategoryId': mainCategoryId}),
        headers: headers);
  ...
  Scaffold buildScaffold(CategoryDetailModel res, bool loading) {
    return Scaffold(
      appBar: AppBarNew(title: Lang(context).categories, actions: [
        AppbarBasketIcon(
          context: context,
